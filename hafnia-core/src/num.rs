//! Hafnia's numeric values. This is broken out into a separate module because the
...
/// integer sizes supported by Hafnia, and their concrete values are their sizes
/// in bits.
